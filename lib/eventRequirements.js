...
// Not currently imported by any live screen (confirmed — this module has
// zero real consumers today, only its own verify script), but kept in sync
// with lib/eventResolver.js's copy anyway in case it's ever revived.
const INACTIVE_BOOKING_STATUSES = new Set(['cancelled', 'payment_failed', 'inquiry']);
