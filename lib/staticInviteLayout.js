...
export function buildStaticLayoutModel({ archetypeId, variantId, event, values, isNonFestive = false, qrTargetUrl = null, photoUrl = null } = {}) {
  ...
  const slots = {
    ...
    [STATIC_SLOT.KICKER]: values?.kickerText || values?.ceremonyName?.toUpperCase() || values?.ceremonyType?.toUpperCase() || null,
