...
export const TOUR_DEFINITIONS = [
  ...
  // Added per Anish's request ("add more tutorials for invites and other
  // planning options") — InviteHub is the one front door for both invite
  // systems (see invites-hub-consolidation.md), and Menu Planner is the
  // other real planning destination that had no tour yet.
  { key: 'invites_intro', label: 'Invites' },
  { key: 'menuplanner_intro', label: 'Menu Planner' },
];
