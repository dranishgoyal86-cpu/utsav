...
// the brief. As of Production Batch 2 (Baby Shower, Naming Ceremony,
// Housewarming, Corporate Conference, Product Launch), 15 entries are
// IMPLEMENTED (the 10 from Production Batch 1 — toran-heritage,
// royal-palace, ivory-mandala, botanical-romance, photo-editorial,
// mughal-garden, night-bloom, playful-pop, illustrated-story, celestial —
// plus folk-celebration, temple-heritage, modern-indian, corporate-grid,
// luxury-black) and the remaining 3 (cultural-poster, stillness,
// wellness-earth) stay 'planned' — pure metadata, never selectable in
