...
export default {
  ...
  web: {
    ...
    scenePreset: ['opening', 'couple', 'honouree', 'family', 'story', 'functions', 'venue', 'dress-code', 'travel', 'transport', 'stay', 'guest-access', 'rsvp', 'registration', 'contact', 'gallery', 'wishing-wall', 'closing'],
  },
  motionPresets: ['drift'],
  supports: {
