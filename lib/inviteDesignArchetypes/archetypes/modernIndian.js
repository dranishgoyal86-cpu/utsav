...
export default {
  ...
  web: {
    ...
    scenePreset: ['opening', 'couple', 'honouree', 'family', 'story', 'functions', 'venue', 'dress-code', 'travel', 'stay', 'transport', 'guest-access', 'rsvp', 'registration', 'speakers', 'contact', 'gallery', 'closing'],
  },
  motionPresets: ['drift'],
  supports: {
