...
export default {
  ...
  web: {
    supported: true,
    // Batch 3 — added honouree/story: botanical-romance is also recommended
    // for mundan (child honouree) and wellness-retreat (facilitator
    // honouree + destination/programme narrative text).
    scenePreset: ['opening', 'invocation', 'couple', 'honouree', 'family', 'story', 'functions', 'venue', 'dress-code', 'travel', 'stay', 'guest-access', 'rsvp', 'gallery', 'wishing-wall', 'closing'],
  },
