...
export default {
  ...
  web: {
    supported: true,
    // Visual QA pass fix — see archetypes/mughalGarden.js's identical
    // comment (this preset omitted 'wishing-wall' despite
    // supports.wishingWall being true below).
    scenePreset: ['opening', 'honouree', 'story', 'venue', 'dress-code', 'guest-access', 'rsvp', 'tickets', 'contact', 'gallery', 'wishing-wall', 'closing'],
  },
