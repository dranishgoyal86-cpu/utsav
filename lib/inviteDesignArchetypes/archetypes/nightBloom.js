...
export default {
  ...
  web: {
    ...
    // Batch 4 — added story/tickets/contact: also recommended for
    // concert/festival-fair, public-event contexts with no couple/family
    // content (those scenes simply won't resolve there).
    scenePreset: ['opening', 'invocation', 'couple', 'family', 'story', 'functions', 'venue', 'dress-code', 'travel', 'stay', 'guest-access', 'rsvp', 'tickets', 'contact', 'gallery', 'wishing-wall', 'closing'],
  },
