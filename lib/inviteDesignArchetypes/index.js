...
// DESIGN_LEVEL). 10 archetypes are implemented in production detail as of
// Production Batch 1 (Hindu Wedding, Engagement, Nikah, Kids Birthday) —
// the original 3-archetype Hindu Wedding pilot (toran-heritage,
// royal-palace, ivory-mandala) plus botanical-romance, photo-editorial,
...
export const FUTURE_ARCHETYPE_IDS = Object.freeze([
  'temple-heritage', 'folk-celebration', 'modern-indian',
  'luxury-black', 'corporate-grid', 'cultural-poster', 'stillness', 'wellness-earth',
]);
