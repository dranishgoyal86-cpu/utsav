...
// DESIGN_LEVEL). 17 archetypes are implemented in production detail as of
// Production Batch 4 (Exhibition, Concert, Festival/Fair, Sports Event) —
// Batches 1-3's 16 + cultural-poster, Utsav's primary public-event
// direction. Only 'stillness' remains unimplemented.
// FUTURE_ARCHETYPE_IDS below documents the remaining direction set still
// unimplemented; adding one later is a new archetypes/*.js + variants/*.js
// file plus one registry entry, same shape as adding an inviteSchemas
// dedicated schema.
...
import botanicalRomance from './archetypes/botanicalRomance';
import photoEditorial from './archetypes/photoEditorial';
import mughalGarden from './archetypes/mughalGarden';
import nightBloom from './archetypes/nightBloom';
import playfulPop from './archetypes/playfulPop';
import illustratedStory from './archetypes/illustratedStory';
import celestial from './archetypes/celestial';
import folkCelebration from './archetypes/folkCelebration';
import templeHeritage from './archetypes/templeHeritage';
import modernIndian from './archetypes/modernIndian';
import corporateGrid from './archetypes/corporateGrid';
import luxuryBlack from './archetypes/luxuryBlack';
import wellnessEarth from './archetypes/wellnessEarth';
import culturalPoster from './archetypes/culturalPoster';

import marigoldGarland from './variants/marigoldGarland';
import redBandhani from './variants/redBandhani';
...
import roseGarden from './variants/roseGarden';
import editorialIvory from './variants/editorialIvory';
import emeraldMehfil from './variants/emeraldMehfil';
import midnightJasmine from './variants/midnightJasmine';
import confettiPop from './variants/confettiPop';
import comicBurst from './variants/comicBurst';
import storybookParty from './variants/storybookParty';
import spaceAdventure from './variants/spaceAdventure';
import festiveBlessing from './variants/festiveBlessing';
import sacredThreshold from './variants/sacredThreshold';
import modernHome from './variants/modernHome';
import executiveLight from './variants/executiveLight';
import summitDark from './variants/summitDark';
import spotlightBlack from './variants/spotlightBlack';
import forestRetreat from './variants/forestRetreat';
import galleryPoster from './variants/galleryPoster';
import livePoster from './variants/livePoster';
...
const ARCHETYPES_BY_ID = Object.freeze({
  ...
  'mughal-garden': mughalGarden,
  'night-bloom': nightBloom,
  'playful-pop': playfulPop,
  'illustrated-story': illustratedStory,
  'celestial': celestial,
  'folk-celebration': folkCelebration,
  'temple-heritage': templeHeritage,
  'modern-indian': modernIndian,
  'corporate-grid': corporateGrid,
  'luxury-black': luxuryBlack,
  'wellness-earth': wellnessEarth,
  'cultural-poster': culturalPoster,
});

const VARIANTS_BY_ID = Object.freeze({
  'marigold-garland': marigoldGarland,
  'red-bandhani': redBandhani,
  'jaipur-peacock': jaipurPeacock,
  'maroon-jharokha': maroonJharokha,
  'gold-lotus': goldLotus,
  'rose-garden': roseGarden,
  'editorial-ivory': editorialIvory,
  'emerald-mehfil': emeraldMehfil,
  'midnight-jasmine': midnightJasmine,
  'confetti-pop': confettiPop,
  'comic-burst': comicBurst,
  'storybook-party': storybookParty,
  'space-adventure': spaceAdventure,
  'festive-blessing': festiveBlessing,
  'sacred-threshold': sacredThreshold,
  'modern-home': modernHome,
  'executive-light': executiveLight,
  'summit-dark': summitDark,
  'spotlight-black': spotlightBlack,
  'forest-retreat': forestRetreat,
  'gallery-poster': galleryPoster,
  'live-poster': livePoster,
});
